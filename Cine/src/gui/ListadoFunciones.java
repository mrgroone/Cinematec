...
public class ListadoFunciones extends JDialog implements ActionListener {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListadoFunciones dialog = new ListadoFunciones();
	 ...
	 * Create the dialog.
	 */
	public ListadoFunciones() {
		setTitle("Listado Funciones");
