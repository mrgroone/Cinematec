...
public class MantenimientoSalas extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MantenimientoSalas dialog = new MantenimientoSalas();
	...
	protected void actionPerformedBtnListado(ActionEvent arg0) {
		ListadoSalas x = new ListadoSalas();
