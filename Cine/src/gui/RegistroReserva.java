...
public class RegistroReserva extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getSource() == btnElegir) {
			actionPerformedBtnElegir(arg0);
		}
	...
	protected void actionPerformedBtnGenerar(ActionEvent arg0) {
		...
		imprimir("Entradas Menores de 11 años : 0");
		imprimir("Entradas Mayores de 60 años : 1");
	...
	protected void actionPerformedBtnElegir(ActionEvent arg0) {
		RegistroReservaButacas x = new RegistroReservaButacas();
		x.setLocationRelativeTo(this);
		x.setVisible(true);
	}
}
